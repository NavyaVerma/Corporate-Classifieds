...
insert into Employee(id,name,gender,age) values(1,'navya','male',22);
...
insert into Employee(id,name,gender,age) values(4,'johnny','male',29);
insert into Employee(id,name,gender,age) values(5,'depp','male',5);

insert into Offer(id,name,category,emp_id) values(1,'offer 1' ,'electronics',3);
insert into Offer(id,name,category,emp_id) values(2,'offer 2' ,'plants',3);
insert into Offer(id,name,category,emp_id) values(3,'offer 4' ,'plants',2);
insert into Offer(id,name,category,emp_id) values(4,'offer 5' ,'furniture',1);
insert into Offer(id,name,category,emp_id) values(5,'offer 6' ,'electronics',2);
